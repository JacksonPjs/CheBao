...
import com.chebao.Adapter.DepositListAdapter;
...
public class Fragment_invest extends Fragment implements LoadingLayout.OnReloadListener,
    ...
    List<DepositListBean.DataBean> biaoBeenList;
...
//            RecyclerView publicLv;
    ...
    private void net(final int stype, final int inrefresh) {
        NetWorks.appInvestHqRecord(getCookie(),""+page,new Subscriber<DepositListBean>(){
            ...
            @Override
            public void onNext(DepositListBean findBean) {
                if (stype == 0) {
    ...
    private void initView() {
        ...
        adapter = new DepositListAdapter(biaoBeenList, getActivity());

...
import com.chebao.Adapter.ConsultationAdapter;
import com.chebao.R;
...
public class consultationAppFragemnt extends Fragment implements LoadingLayout.OnReloadListener,
    ...
    List<ConsultationBean.DataBean> biaoBeenList;
...
//            RecyclerView publicLv;
    ...
    private void net(final int stype, final int inrefresh) {
        NetWorks.consultationPageApp(new Subscriber<ConsultationBean>() {
            @Override
            ...
            @Override
            public void onNext(ConsultationBean biaoBean) {

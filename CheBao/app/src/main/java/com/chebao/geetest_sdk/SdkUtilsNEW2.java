package com.chebao.geetest_sdk;
...
public class SdkUtilsNEW2 {
    ...
    public void verificationNewUserPhone(final Context context, final Activity activity, final EditText phoneEdit) {
     ...
     //   this.noncestr = UUIDs.uuid();
        ...
        NetWorks.forGetPassPhone(phone, new Subscriber<InfoBean>() {
            @Override
            public void onStart() {
    ...
    private SdkUtilsNEW2.GtAppValidateTask mGtAppValidateTask;
        ...
        dialog.setGtListener(new GtDialog.GtListener() {
            ...
            public void gtResult(boolean success, String result) {
              ...
              //      toastMsg("滑动正确");
                    ...
                    SdkUtilsNEW2.GtAppValidateTask gtAppValidateTask = new SdkUtilsNEW2.GtAppValidateTask();

 ...
 * 
 */
@SuppressLint("WrongViewCast") public class MyDialog3 extends Dialog {
	...
	public static class Builder {
		...
		public MyDialog3 create() {
			LayoutInflater inflater = (LayoutInflater) context
					.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			final MyDialog3 dialog = new MyDialog3(context, R.style.update_ialog);
			View layout = inflater.inflate(R.layout.dialog_zdy_layout, null);

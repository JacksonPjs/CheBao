...
public class CircleProgress extends View {
    ...
    private int[] mGradientColors = {getResources().getColor(R.color.org_home), getResources().getColor(R.color.org_home_btn)};
    //当前进度，[0.0f,1.0f]
...
//        setValue(mValue);
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mValueColor = typedArray.getColor(R.styleable.CircleProgressBar_valueColor, getResources().getColor(R.color.org_home));
...
//        canvas.drawText(String.format(mPrecisionFormat, mValue), mCenterPoint.x, mValueOffset, mValuePaint);
        ...
        if (mHint != null) {
            canvas.drawText(mHint.toString(), mCenterPoint.x, mValueOffset, mValuePaint);
        }
